...
describe('SearchBoxComponent', () => {
  ...
  it('should show clear button when value exists', () => {
    ...
    fixture.detectChanges();
    let clearButton = fixture.nativeElement.querySelector('.ng-clear-button');
    expect(clearButton).toBeNull();

    fixture.componentRef.setInput('value', 'test');
    fixture.detectChanges();
    clearButton = fixture.nativeElement.querySelector('.ng-clear-button');
  ...
  it('should hide clear button when showClearButton is false', () => {
    ...
    const clearButton = fixture.nativeElement.querySelector('.ng-clear-button');
    expect(clearButton).toBeNull();
  });

  it('should show search icon by default', () => {
    const icon = fixture.nativeElement.querySelector('.ng-search-icon');
  ...
  it('should show loading indicator when loading is true', () => {
    ...
    fixture.detectChanges();
    let indicator = fixture.nativeElement.querySelector('.ng-loading-indicator');
    expect(indicator).toBeNull();

    fixture.componentRef.setInput('loading', true);
    fixture.detectChanges();
    indicator = fixture.nativeElement.querySelector('.ng-loading-indicator');
